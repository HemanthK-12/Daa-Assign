...
void bronKerboschPivot(set<int> P,set<int> R,set<int> X,vector<vector<int>>& graph,int& count/*reference here coz we are making changes in the count variable in bronkerboschdegeneracy method*/) {
